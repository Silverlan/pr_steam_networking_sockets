...
namespace pragma::networking {
	class SteamServer;
	class SteamServerClient : public pragma::networking::IServerClient, public NetPacketReceiver, public NetPacketDispatcher {
	  public:
...
pragma::networking::SteamServerClient::SteamServerClient(SteamServer &sv, HSteamNetConnection con) : m_hConnection {con}, m_server {sv} {}
...
bool pragma::networking::SteamServerClient::SendPacket(pragma::networking::Protocol protocol, NetPacket &packet, pragma::networking::Error &outErr) { return NetPacketDispatcher::SendPacket(GetInterface(), m_hConnection, protocol, packet, outErr); }

/////////////

namespace pragma::networking {
	class SteamServer : public pragma::networking::IServer, public BaseSteamNetworkingSocket {
	  public:
	...
	case k_ESteamNetworkingConnectionState_ProblemDetectedLocally:
		{
			...
			DropClient(*itCl->second, (pInfo->m_info.m_eState == k_ESteamNetworkingConnectionState_ClosedByPeer) ? pragma::networking::DropReason::Disconnected : pragma::networking::DropReason::Error, err);
			break;
		}
...
#ifndef USE_STEAMWORKS_NETWORKING
void pragma::networking::SteamServer::OnSteamNetConnectionStatusChanged(SteamNetConnectionStatusChangedCallback_t *pInfo) { OnConnectionStatusChanged(pInfo); }
#endif

ISteamNetworkingSockets &pragma::networking::SteamServerClient::GetInterface() const { return m_server.GetInterface(); }
